/* Southern Africa Species Explorer — service worker
   ...
   Bump SHELL_CACHE when data.js / names.js / bold.js / lists.js / app.js / index.html change. */
importScripts('./precache-list.js');

var SHELL_CACHE = 'sa-shell-v32';   // ← bump on shell change
var MEDIA_CACHE = 'sa-media-v1';    // ← stable; keep across shell bumps
var SHELL = ['./', './index.html', './data.js', './names.js', './bold.js', './lists.js', './app.js', './precache-list.js', './manifest.json', './icon.svg'];
